...
function Chat() {
  ...
  //             <p class="text-grey-darkest">{data.id}</p>
  ...
  //        <Heading size="md">
  //          {data?.name ?? 'Anon'}
  //          {auth && auth?.account === data.account ? ' (You)' : ''}
  //        </Heading>
  //        <Box>{data.id}</Box>
  //      </Stack>
  //    </Box>
              ...
              <div class="w-2/3 border flex flex-col">
                ...
                <div
                  ...
                  <div class="py-2 px-3">
                    ...
                    {/* {chatRef.record(formInput.message).get() == chatformInput.toAddress} */}
                    <div class="flex mb-2">
                      <div
